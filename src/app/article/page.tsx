...
// const { data: setting, isLoading: isSettingLoading, isFetching: isSettingFetching, refetch: refetchSetting, isError: isSettingError } = useInformation({}, "article");
// const { data, isLoading, isFetching, refetch, isError } = useArticle({"search": search, "categoryId": categoryId});

const { data: setting } = useInformation({}, "article");
const { data, isLoading, isFetching, isError } = useArticle({"search": search, "categoryId": categoryId});
