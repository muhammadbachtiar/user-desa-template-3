                    ...
                    <div className="col-span-6 grid grid-cols-12 px-3 md:px-0 gap-6 sm:w-full">
                      {allTour.map((card) => (
                        <Link
                          ...
                          href={`/tour/${card?.slug ?? ""}`}
                          key={card.id}
                          className="col-span-12 rounded-4xl md:col-span-6 xl:col-span-4 flex flex-col justify-center dark:bg-gray-800 group hover:scale-100 focus:scale-100 transition duration-300 ease-in-out"
                        >
                          <div className="col-span-12 rounded-4xl md:col-span-6 xl:col-span-4 flex flex-col justify-center dark:bg-gray-800 group hover:scale-100 focus:scale-100 transition duration-300 ease-in-out">
                            <div className="relative rounded-4xl overflow-hidden min-h-[68vh] flex justify-center items-end">
                              ...
                              <div className="relative bg-gradient-to-t from-black/70 via-black/55 to-black/0 rounded-b-4xl w-full p-6">
                                <div className="flex flex-col gap-2">
                                  <h5 className="text-3xl md:text-4xl font-bold mb-3 tracking-tighter text-white dark:text-white">
                                    {card.title}
                                  </h5>
                                </div>
                                <div className="flex items-center mt-2">
                                  <p className="text-sm sm:text-base md:text-lg font-semibold text-white/90 max-w-md line-clamp-3">
                                    {card?.description ??
                                      "[Deskripsi tidak tersedia]"}
                                  </p>
                                </div>
                                <div className="col-span-2 lg:col-span-1 text-start mt-4">
                                  {card?.address && (
                                    <div className="flex justify-start items-center gap-x-2">
                                      <BiMap className="min-w-4 min-h-4 rounded-sm text-white"></BiMap>
                                      <span className="text-md font-normal mb-0 text-white dark:text-white ">
                                        {card?.address ??
                                  ...
                                  {card?.link?.website && (
                                    <div className="flex justify-start items-center gap-x-2">
                                      <BiGlobe className="min-w-4 min-h-4 rounded-sm text-white"></BiGlobe>
                                      <span className="text-md font-normal mb-0 text-white dark:text-white">
                                        {card?.link?.website ?? ""}
                                      </span>
                                    </div>
                                  ...
                                  {card?.link?.email && (
                                    <div className="flex justify-start items-center gap-x-2">
                                      <CgMail className="min-w-4 min-h-4 rounded-sm text-white"></CgMail>
                                      <span className="text-md font-normal mb-0 text-white dark:text-white">
                                        {card?.link?.email ?? ""}
                                      </span>
                                    </div>
