                                    ...
                                    {data.value.map((card) => 
                                        <div tabIndex={1} key={card.id} className="col-span-12 rounded-4xl md:col-span-6 xl:col-span-4 flex flex-col justify-center dark:bg-gray-800 group hover:scale-100 focus:scale-100 transition duration-300 ease-in-out">    
                                            <div className="relative rounded-4xl overflow-hidden min-h-[68vh] flex justify-center items-end">
                                                <Image
                                                        className="rounded-4xl absolute top-0 left-0 w-full h-full object-cover group-hover:scale-110 group-focus:scale-110 transition duration-300 ease-in-out"
                                                        src={card.thumbnail}
                                                        alt="Tour Thumbnail"
                                                        width={500}
                                                        height={300}
                                                    ...
                                                    <div className="relative bg-gradient-to-t from-gray-900 via-gray-900 to-black/0 rounded-b-4xl w-full p-6">
